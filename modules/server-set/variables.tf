...
variable "name" {
  type        = string
  description = "Prefix node pool name"
}
...
variable "virtual_network_id" {
  type        = string
  description = "Virtual network id where to deploy the node pool"
}

variable "subnet_id" {
  type        = string
  description = "Subnet id where to deploy the node pool"
}
...
variable "overprovision" {
  default     = false
  type        = bool
  description = "Flag to overprovision the node pool"
}
...
variable "zone_balance" {
  type        = bool
  description = "Flag to balance the node pool across availability zones"
}
